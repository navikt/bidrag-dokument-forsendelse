        ...
        assertSoftly("Skal validere forsendelse etter distribusjon") {
            ...
            stubUtils.Valider().opprettJournalpostKaltMed(
                "{" +
                        ...
                        "\"dokumenter\":[" +
                        "{\"tittel\":\"Ny tittel dokument fra Joark\",\"dokumentreferanse\":\"${opprettetForsendelseOppdatert.dokumenter[0].dokumentreferanse}\"}," +
                        ...
                        "{\"tittel\":\"Ny tittel koblet dokument fra original\",\"brevkode\":\"$DOKUMENTMAL_UTGÅENDE\",\"dokumentreferanse\":\"${opprettetForsendelseOppdatert.dokumenter[2].dokumentreferanse}\"}]," +

...
object ForespørselValidering {
    fun OpprettForsendelseForespørsel.valider(forsendelseType: ForsendelseType) {
        ...
        val harFlereDokumenterMedSammeReferanse = this.dokumenter.any { this.dokumenter.harFlereDokumenterMedSammeJournalpostIdOgReferanse(it) }
    ...
    fun OpprettDokumentForespørsel.valider(index: Int? = null, throwWhenInvalid: Boolean = true): List<String>{

...
data class DokumentSoknadDto(
    ...
    val endretDato: java.time.OffsetDateTime? = null,
    // Opprettet dato og tid som UTC
    @get:JsonProperty("innsendtDato")
    val innsendtDato: java.time.OffsetDateTime? = null,
    ...
    val innsendingsFristDato: java.time.OffsetDateTime? = null,
    ...
    val forsteInnsendingsDato: java.time.OffsetDateTime? = null,
    ...
    val skalSlettesDato: java.time.OffsetDateTime? = null,

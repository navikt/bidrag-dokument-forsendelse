...
class CacheConfig {
    companion object {
        ...
        const val VEDTAK_CACHE2 = "VEDTAK_CACHE2"
    ...
    fun cacheManager(
        ...
        caffeineCacheManager.registerCustomCache(VEDTAK_CACHE2, Caffeine.newBuilder().expireAfterWrite(1, TimeUnit.HOURS).build())
